...
$(document).ready(function(){
    // Sign content should have been written to stringContent.txt by Streamer.bot application
    // Read the contents of stringContent.txt and feed that into the script.
    var file = "stringContent.txt";
    ...
    reader.onload = (e) => {
        ...
        _this.$typesomething.val(lines.join('\n'));
        $( "#showme" ).click()
        .delay(5 * 1000);
    }
